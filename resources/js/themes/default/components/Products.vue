				...
				<div class="container p-0">
					<div class="row">
						...
						<div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
							...
							<div class="row">
								<!-- PRODUCT-->
								<div v-bind:key="product.id" v-for="product in allProducts" class="col-lg-4 col-sm-6">
									<div class="product text-center">
										<div class="mb-3 position-relative">
											<div class="badge text-white badge-"></div>
											<router-link class="d-block" :to="`products/${product.slug}`"><img class="img-fluid w-100" :src="product.files[0].path" :alt="product.title"/></router-link>
...
export default {
    ...
    components: {
		...
		Footer: () => import('../layout/TempFooter'),
	},
};
</script>
<style lang="scss">
