			...
			<div class="container">
				<div class="row mb-5">
						...
						<div class="row m-sm-0">
							<div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
								<div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
									<div :key="file.id" v-for="file in singleProduct.files" class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0">
										<img class="w-100" :src="file.path" alt="..." />
									</div>
								</div>
							</div>
							<div class="col-sm-10 order-1 order-sm-2">
								<div class="owl-carousel product-slider" data-slider-id="1">
									<a :key="file.id" v-for="file in singleProduct.files"
										class="d-block"
										:href="file.path"
										data-lightbox="product"
										:title="singleProduct.name"
									>
										<img class="img-fluid" :src="file.path" alt="..." />
									</a>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-6">
						...
						<p class="text-muted lead">{{singleProduct.price}}</p>
						<p class="text-small mb-4">{{singleProduct.description}}</p>
						<div class="row align-items-stretch mb-4">
						...
						<ul class="list-unstyled small d-inline-block">
							<li class="px-3 py-2 mb-1 bg-white">
								...
								<span class="ml-2 text-muted">{{singleProduct.sku}}</span>
							</li>
				...
				<div class="tab-content mb-5" id="myTabContent">
					...
					>
						<div class="p-4 p-lg-5 bg-white">
							...
							<p class="text-muted text-small mb-0">{{singleProduct.description}}</p>
						</div>
					</div>
					<div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
						<div class="p-4 p-lg-5 bg-white">
							<div class="row">
								<div class="col-lg-8">
									<div v-for="rating in singleProduct.ratings" :key="rating.id" class="media mb-3">
										<img class="rounded-circle" src="../img/customer-1.png" alt width="50" />
										<div class="media-body ml-3">
											<h6 class="mb-0 text-uppercase">{{rating.user.name}}</h6>
											<p class="small text-muted mb-0 text-uppercase">{{new Date(rating.created_at).toDateString()}}</p>
											<ul class="list-inline mb-1 text-xs">
												<star-rating :inline="true" :star-size="20" :read-only="true" :show-rating="false" :rating="rating.value" :star-points="[23,2, 14,17, 0,19, 10,34, 7,50, 23,43, 38,50, 36,34, 46,19, 31,17]"></star-rating>
											</ul>
											<p class="text-small mb-0 text-muted">{{rating.feedback}}</p>
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-sm-6">
						<div class="product text-center skel-loader">
							...
							<h6>
								<a class="reset-anchor" href="detail.html">Air Jordan 12 gym red</a>
							</h6>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="product text-center skel-loader">
							...
							<h6>
								<a class="reset-anchor" href="detail.html">Timex Unisex Originals</a>
							</h6>
...
export default {
	...
	components: {
		...
		TempFooter: () => import('../layout/TempFooter'),
	},
	beforeMount() {
